...
/**
 * ehWidgetFormJQueryDate represents a date widget rendered by JQuery UI.
 *
 * This widget needs JQuery and JQuery UI to work.
 * Nota: Corrección de sfWidgetFormJQueryDate para que funcione con jQuery 1.6+
 *
 * @package    symfony
 * @subpackage widget
 ...
 */
class ehWidgetFormJQueryDate extends sfWidgetForm
{
  /**
