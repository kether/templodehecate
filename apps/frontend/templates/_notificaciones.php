<div id="tdh_notificaciones" style="<?php echo ($sf_user->hasFlash('exito') || $sf_user->hasFlash('success') || $sf_user->hasFlash('error') || $sf_user->hasFlash('nota') || $sf_user->hasFlash('notice') || $sf_user->hasFlash('info')) ? 'display: inherit;' : '' ?>" onclick="$('#tdh_notificaciones').fadeToggle('fast');">
<?php 
