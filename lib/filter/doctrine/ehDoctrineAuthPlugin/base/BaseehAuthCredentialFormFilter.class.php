...
/**
 * ehAuthCredential filter form base class.
 *
 ...
 */
abstract class BaseehAuthCredentialFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('eh_auth_credential_filters[%s]');
  ...
  public function addUsersListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('ehAuthCredentialUser.user_id', $values)
    ;
  }
