...
/**
 * ehForoLeidoHilo filter form base class.
 *
 ...
 */
abstract class BaseehForoLeidoHiloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('eh_foro_leido_hilo_filters[%s]');
